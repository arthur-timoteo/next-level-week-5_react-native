        ...
        >
            <View style={styles.container}>
                ...
                <View style={styles.controller}>
                    ...
                    <Text style={styles.alertLabel}>Excolha o melhor horário para ser lembrado</Text>
...

                    {
                        Platform.OS == 'android' && (
                            ...
                            >
                                <Text style={styles.dateTimerPickerText}>{`Mudar ${format(selectedDateTime, 'HH:mm')}`}</Text>
                            </TouchableOpacity>
                        )
                    }
